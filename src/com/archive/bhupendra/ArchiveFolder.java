...
public class ArchiveFolder {
	...
	public ArchiveFolder(String destDir, String sourceDir, String password) throws Exception {

		try {
			File source = new File(sourceDir);
			// Initiate ZipFile object with the path/name of the zip file.
			ZipFile zipFile = new ZipFile(destDir + File.separator + ACrypt.encrypt(source.getName()) + ".f");
